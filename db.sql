...
-- Volcando datos para la tabla proyecto.docente_contrato: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla proyecto.docente_visitante: ~1 rows (aproximadamente)
