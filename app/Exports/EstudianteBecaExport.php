...
class EstudianteBecaExport implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        $estudiantes = DB::table('persona')
            ->select(
                'persona.id','per_tipo_documento','per_numero_documento','per_nombre','per_apellido','per_telefono','estu_telefono2',
                'per_correo','dep_nombre','mun_nombre','pro_nombre','pp_plan','estu_direccion','estu_estrato','estu_fecha_nacimiento','estu_fecha_expedicion','estu_sexo',
                'estu_estado_civil','estu_ingreso','estu_periodo_ingreso','estu_ult_matricula','estu_semestre','estu_financiamiento','estu_entidad','estu_estado',
