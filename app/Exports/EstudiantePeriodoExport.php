...
class EstudiantePeriodoExport implements FromCollection, WithHeadings
{

    public function __construct(int $programa, String $periodo)
    {
    ...
    public function collection()
    {
        $estudiantes = DB::table('persona')
            ...
            ->where('estudiante.estu_periodo_ingreso', $this->periodo)
            ->get();
        return $estudiantes;
    }
}
