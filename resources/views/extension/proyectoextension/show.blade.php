...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/extension/{{$proyectoextension->id}}/verproyectoextension">Vista</a> / <a href="/extension/mostrarproyectoextension">Proyectos extensión</a> / <a href="/extension">Extension - internacionalización</a>
    @endsection
    @section('title')
        ...
        <div class="tile">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_year') is-invalid @enderror" name="extprex_year"
                        ...
                        autocomplete="extprex_year" autofocus disabled>
                    @error('extprex_year')
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_semestre') is-invalid @enderror" name="extprex_semestre"
                        id="extprex_semestre" value="{{ $proyectoextension->extprex_semestre }}" type="number"
                        autocomplete="extprex_semestre" autofocus disabled>
                    @error('extprex_year')
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_codigo_organizacional') is-invalid @enderror"
                        ...
                        autocomplete="extprex_codigo_organizacional" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_codigo_pr') is-invalid @enderror"
                        name="extprex_codigo_pr" id="extprex_codigo_pr"
                        value="{{ $proyectoextension->extprex_codigo_pr }}" type="text"
                        autocomplete="extprex_codigo_pr" autofocus disabled>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_nombre_pr') is-invalid @enderror"
                        name="extprex_nombre_pr" id="extprex_nombre_pr"
                        value="{{ $proyectoextension->extprex_nombre_pr }}" type="text"
                        autocomplete="extprex_nombre_pr" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="extprex_descripcion_pr" id="extprex_descripcion_pr" cols="30"
                        rows="10" disabled>{{ $proyectoextension->extprex_descripcion_pr }}</textarea>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_valor_pr') is-invalid @enderror" name="extprex_valor_pr"
                        id="extprex_valor_pr" value="{{ $proyectoextension->extprex_valor_pr }}" type="text"
                        autocomplete="extprex_valor_pr" autofocus disabled>
                    ...
                    <select class="form-select" name="extprex_id_area_extension" id="extprex_id_area_extension"
                        ...
                        @foreach ($areas as $area)
                            <option value="{{ $area->id }}"
                                {{ $area->id == $proyectoextension->extprex_id_area_extension ? 'selected' : '' }}>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_fecha_inicio') is-invalid @enderror"
                        ...
                        value="{{ $proyectoextension->extprex_fecha_inicio }}" type="date"
                        autocomplete="extprex_fecha_inicio" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_fecha_final') is-invalid @enderror"
                        ...
                        value="{{ $proyectoextension->extprex_fecha_final }}" type="date"
                        autocomplete="extprex_fecha_final" autofocus disabled>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_nombre_contacto') is-invalid @enderror"
                        ...
                        autocomplete="extprex_nombre_contacto" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_apellido_contacto') is-invalid @enderror"
                        ...
                        autocomplete="extprex_apellido_contacto" autofocus disabled>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_telefono_contacto') is-invalid @enderror"
                        ...
                        autocomplete="extprex_telefono_contacto" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_correo_contacto') is-invalid @enderror"
                        ...
                        autocomplete="extprex_correo_contacto" autofocus disabled>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="extprex_id_area_trabajo" id="extprex_id_area_trabajo" disabled>
                        <option value="">---- SELECCIONE ----</option>
                        @foreach ($areastrabajo as $trabajo)
                            <option value="{{ $trabajo->id }}"
                                {{ $trabajo->id == $proyectoextension->extprex_id_area_trabajo ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="extprex_id_ciclo_vital" id="extprex_id_ciclo_vital" disabled>
                        <option value="">---- SELECCIONE ----</option>
                        <option value="1" {{ $proyectoextension->extprex_id_ciclo_vital == '1' ? 'selected' : '' }}>
                            Primera
                            infancia (0-5 años)</option>
                        <option value="2" {{ $proyectoextension->extprex_id_ciclo_vital == '2' ? 'selected' : '' }}>
                            Niñez (6-11
                            años)</option>
                        <option value="3" {{ $proyectoextension->extprex_id_ciclo_vital == '3' ? 'selected' : '' }}>
                            Jóvenes
                            (12-26 años)</option>
                        <option value="4" {{ $proyectoextension->extprex_id_ciclo_vital == '4' ? 'selected' : '' }}>
                            Adultos
                            (26-60 años)</option>
                        <option value="5" {{ $proyectoextension->extprex_id_ciclo_vital == '5' ? 'selected' : '' }}>
                            Adultos
                            mayores (+60 años)</option>
                    </select>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="extprex_id_entidad_nacional" id="extprex_id_entidad_nacional"
                        disabled>
                        <option value="">---- SELECCIONE ----</option>
                        @foreach ($entidadesnac as $entidadenac)
                            <option value="{{ $entidadenac->id }}"
                                {{ $entidadenac->id == $proyectoextension->extprex_id_entidad_nacional ? 'selected' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="extprex_id_fuente_nacional" id="extprex_id_fuente_nacional"
                        disabled>
                        <option value="">---- SELECCIONE ----</option>
                        @foreach ($fuentenacionals as $nacional)
                            <option value="{{ $nacional->id }}"
                                {{ $nacional->id == $proyectoextension->extprex_id_fuente_nacional ? 'selected' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control @error('extprex_valor_financiacion_nac') is-invalid @enderror"
                        ...
                        autocomplete="extprex_valor_financiacion_nac" autofocus disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="extprex_id_fuente_internacional"
                        id="extprex_id_fuente_internacional" disabled>
                        <option value="">---- SELECCIONE ----</option>
                        @foreach ($entidadesinter as $entidadinter)
                            <option value="{{ $entidadinter->id }}"
                                {{ $entidadinter->id == $proyectoextension->extprex_id_fuente_internacional ? 'selected' : '' }}>
                                {{ $entidadinter->cofuin_nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    <label for="extprex_id_pais">País financiador (Si la fuente seleccionada es organismo
                        multilateral se debe registrar 0)</label>
                    <input class="form-control @error('extprex_id_pais') is-invalid @enderror" name="extprex_id_pais"
                        id="extprex_id_pais" value="{{ $proyectoextension->extprex_id_pais }}" type="number"
                        autocomplete="extprex_id_pais" autofocus disabled>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_nombre_institucion_inter') is-invalid @enderror"
                        ...
                        autocomplete="extprex_nombre_institucion_inter" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_valor_financiacion_inter') is-invalid @enderror"
                        ...
                        autocomplete="extprex_valor_financiacion_inter" autofocus disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control @error('extprex_nombre_otra_entidad') is-invalid @enderror"
                        ...
                        autocomplete="extprex_nombre_otra_entidad" autofocus disabled>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="extprex_id_sector_otra_entidad"
                        id="extprex_id_sector_otra_entidad" disabled>
                        <option value="">---- SELECCIONE ----</option>
                        @foreach ($sectores as $sector)
                            <option value="{{ $sector->id }}"
                                {{ $sector->id == $proyectoextension->extprex_id_sector_otra_entidad ? 'selected' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control @error('extprex_id_pais_otra_entidad') is-invalid @enderror"
                        ...
                        autocomplete="extprex_id_pais_otra_entidad" autofocus disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="extprex_id_poblacion_condicion"
                        id="extprex_id_poblacion_condicion" disabled>
                        <option value="">---- SELECCIONE ----</option>
                        @foreach ($poblacioncondicions as $poblacioncondicion)
                            <option value="{{ $poblacioncondicion->id }}"
                                {{ $poblacioncondicion->id == $proyectoextension->extprex_id_poblacion_condicion ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_cantidad_condicion') is-invalid @enderror"
                        ...
                        autocomplete="extprex_cantidad_condicion" autofocus disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="extprex_id_poblacion_grupo" id="extprex_id_poblacion_grupo"
                        disabled>
                        <option value="">---- SELECCIONE ----</option>
                        @foreach ($poblaciongrupos as $poblaciongrupo)
                            <option value="{{ $poblaciongrupo->id }}"
                                {{ $poblaciongrupo->id == $proyectoextension->extprex_id_poblacion_grupo ? 'selected' : '' }}>
                                {{ $poblaciongrupo->copogr_nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('extprex_cantidad_grupo') is-invalid @enderror"
                        ...
                        autocomplete="extprex_cantidad_grupo" autofocus disabled>
