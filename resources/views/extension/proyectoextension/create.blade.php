...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/extension/crearproyectoextension">Crear</a> / <a href="/extension/mostrarproyectoextension">Proyectos extensión</a> / <a href="/extension">Extension - internacionalización</a>
    @endsection
    @section('title')
...
@section('content')
    <div class="container-fluid">
        <div class="tile">
            <h4><i class="fa fa-cube"></i> Registro proyecto de extensión</h4><hr>
            <form action="/extension/registroproyectoextension" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="extprex_year">Año *</label>
                        <input class="form-control @error('extprex_year') is-invalid @enderror" name="extprex_year"
                            id="extprex_year" value="{{ old('extprex_year') }}" type="number"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_semestre') is-invalid @enderror"
                            name="extprex_semestre" id="extprex_semestre" value="{{ old('extprex_semestre') }}"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_codigo_organizacional') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_codigo_organizacional') }}" type="text"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_codigo_pr') is-invalid @enderror"
                            name="extprex_codigo_pr" id="extprex_codigo_pr" value="{{ old('extprex_codigo_pr') }}"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_nombre_pr') is-invalid @enderror"
                            name="extprex_nombre_pr" id="extprex_nombre_pr" value="{{ old('extprex_nombre_pr') }}"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_valor_pr') is-invalid @enderror"
                            name="extprex_valor_pr" id="extprex_valor_pr" value="{{ old('extprex_valor_pr') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @error('extprex_id_area_extension') is-invalid @enderror" name="extprex_id_area_extension" id="extprex_id_area_extension">
                            <option value="">---- SELECCIONE ----</option>
                            @foreach ($areas as $area)
                                <option value="{{ $area->id }}">{{ $area->coarex_nombre }}</option>
                            @endforeach
                        </select>
                        @error('extprex_id_area_extension')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_fecha_inicio') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_fecha_inicio') }}" type="date" autocomplete="extprex_fecha_inicio"
                            autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_fecha_final') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_fecha_final') }}" type="date" autocomplete="extprex_fecha_final"
                            autofocus>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_nombre_contacto') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_nombre_contacto') }}" type="text"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_apellido_contacto') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_apellido_contacto') }}" type="text"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_telefono_contacto') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_telefono_contacto') }}" type="number"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_correo_contacto') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_correo_contacto') }}" type="email"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control @error('extprex_valor_financiacion_nac') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_valor_financiacion_nac') }}" type="number"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extprex_id_fuente_internacional"
                            ...
                            @foreach ($entidadesinter as $entidadinter)
                                <option value="{{ $entidadinter->id }}">{{ $entidadinter->cofuin_nombre }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_id_pais') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_id_pais') }}" type="number"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_nombre_institucion_inter') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_nombre_institucion_inter') }}" type="text"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_valor_financiacion_inter') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_valor_financiacion_inter') }}" type="number"
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input class="form-control @error('extprex_nombre_otra_entidad') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_nombre_otra_entidad') }}" type="text"
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control @error('extprex_id_pais_otra_entidad') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_id_pais_otra_entidad') }}" type="number"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extprex_id_poblacion_condicion"
                            ...
                            @foreach ($poblacioncondicions as $poblacioncondicion)
                                <option value="{{ $poblacioncondicion->id }}">{{ $poblacioncondicion->copoco_nombre }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_cantidad_condicion') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_cantidad_condicion') }}" type="number"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extprex_id_poblacion_grupo"
                            ...
                            @foreach ($poblaciongrupos as $poblaciongrupo)
                                <option value="{{ $poblaciongrupo->id }}">{{ $poblaciongrupo->copogr_nombre }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extprex_cantidad_grupo') is-invalid @enderror"
                            ...
                            value="{{ old('extprex_cantidad_grupo') }}" type="number"
