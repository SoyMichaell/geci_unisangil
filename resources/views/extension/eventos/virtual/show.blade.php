...
@else
    @extends('layouts.app')
    @section('navegar')
       <a href="/extension/{{$virtual->id}}/vereventosvirtuales">Vista</a>  / <a href="/extension/mostrareventosvirtuales">Eventos virtuales</a> / <a href="/extension">Extension - internacionalización</a>
    @endsection
    @section('title')
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('exevir_fecha_inicio') is-invalid @enderror"
                        name="exevir_fecha_inicio" id="exevir_fecha_inicio" value="{{ $virtual->exevir_fecha_inicio }}"
                        type="date" autocomplete="exevir_fecha_inicio" autofocus disabled>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('exevir_fecha_fin') is-invalid @enderror" name="exevir_fecha_fin"
                        id="exevir_fecha_fin" value="{{ $virtual->exevir_fecha_fin }}" type="date"
                        autocomplete="exevir_fecha_fin" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('exevir_enlace_ingreso') is-invalid @enderror"
                        ...
                        value="{{ $virtual->exevir_enlace_ingreso }}" type="text" autocomplete="exevir_enlace_ingreso"
                        autofocus disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control @error('exevir_nombre_ponente') is-invalid @enderror" name="exevir_nombre_ponente[]"
                        id="exevir_nombre_ponente" cols="30" rows="10"
                        disabled>{{ $virtual->exevir_nombre_ponente }}</textarea>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <textarea class="form-control @error('exevir_institucion_origen') is-invalid @enderror"
                        name="exevir_institucion_origen[]" id="exevir_institucion_origen" cols="30" rows="10"
                        disabled>{{ $virtual->exevir_institucion_origen }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control @error('exevir_pais') is-invalid @enderror" name="exevir_pais[]" id="exevir_pais"
                        cols="30" rows="10" disabled>{{ $virtual->exevir_pais }}</textarea>
                    @error('exevir_pais')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('exevir_nombre_ponencia') is-invalid @enderror" name="exevir_nombre_ponencia[]"
                        id="exevir_nombre_ponencia" cols="30" rows="10"
                        disabled>{{ $virtual->exevir_nombre_ponencia }}</textarea>
