...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/extension/mostrareventosvirtuales">Eventos virtuales</a> / <a href="/extension">Extension -
            internacionalización</a>
    @endsection
    @section('title')
        <h1 class="titulo"><i class="fa fa-table"></i> Módulo extensión e internacionalización | Eventos virtuales
        </h1>
    @section('message')
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-end align-items-center">
                    <a class="btn btn-outline-danger" style="border-radius: 100%"
                        href="{{ url('extension/exporteventopdf') }}" title="Generar reporte pdf" target="_blank"><i
                            class="fa fa-file-pdf-o"></i></a>
                    <a class="btn btn-outline-success" style="border-radius: 100%"
                        href="{{ url('extension/exporteventoexcel') }}" title="Generar reporte excel"><i
                    ...
                    <tbody>
                        ...
                        @foreach ($eventosvirtuales as $virtuales)
                            <tr>
                                ...
                                <td><a
                                        href="{{ $virtuales->exevir_enlace_ingreso }}">{{ $virtuales->exevir_enlace_ingreso }}</a>
                                </td>
                                <td><a
                                        href="{{ $virtuales->exevir_enlace_imagen }}">{{ $virtuales->exevir_enlace_imagen }}</a>
                                </td>
