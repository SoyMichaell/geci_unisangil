            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-end align-items-center">
                    <a class="btn btn-outline-danger" style="border-radius: 100%"
                        href="{{ url('extension/exportcurriculopdf') }}" title="Generar reporte pdf"
                        target="_blank"><i class="fa fa-file-pdf-o"></i></a>
                    <a class="btn btn-outline-success" style="border-radius: 100%"
                        href="{{ url('extension/exportcurriculoexcel') }}" title="Generar reporte excel"><i
                    ...
                    <tbody>
                        ...
                        @foreach ($curriculos as $curriculo)
                            <tr>
                                ...
                                <td>{{ $curriculo->docentes->per_nombre . ' ' . $curriculo->docentes->per_apellido }}
                                </td>
                                <td>
                                    <form action="/extension/{{ $curriculo->id }}/eliminarcurriculo" method="POST">
                                        <div class="d-flex">
                                            <a class="btn btn-sm"
