        ...
        <div class="tile">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control @error('exmona_tipo') is-invalid @enderror" name="exmona_tipo"
                        ...
                        <option value="entrante" {{ $nacional->exmona_tipo == 'entrante' ? 'selected' : '' }}>
                            Entrante</option>
                        <option value="saliente" {{ $nacional->exmona_tipo == 'saliente' ? 'selected' : '' }}>
                            Saliente</option>
                    </select>
                    @error('exmona_tipo')
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control @error('exmona_rol') is-invalid @enderror" name="exmona_rol"
                        ...
                        <option value="estudiante" {{ $nacional->exmona_rol == 'estudiante' ? 'selected' : '' }}>
                            Estudiante</option>
                        <option value="docente" {{ $nacional->exmona_rol == 'docente' ? 'selected' : '' }}>Docente
                        </option>
                        <option value="administrativo"
                            {{ $nacional->exmona_rol == 'administrativo' ? 'selected' : '' }}>Administrativo
                        </option>
                    </select>
                    @error('exmona_rol')
                        <span class="invalid-feedback" role="alert">
                    ...
                    <select class="form-control @error('exmona_id_sede') is-invalid @enderror" name="exmona_id_sede"
                        ...
                        @foreach ($sedes as $sede)
                            <option value="{{ $sede->id }}"
                                {{ $sede->id == $nacional->exmona_id_sede ? 'selected' : '' }}>
                    ...
                    <select class="form-control @error('exmona_id_facultad') is-invalid @enderror"
                        ...
                        @foreach ($facultades as $facultad)
                            <option value="{{ $facultad->id }}"
                                {{ $facultad->id == $nacional->exmona_id_facultad ? 'selected' : '' }}>
                    ...
                    <select class="form-control @error('exmona_id_programa') is-invalid @enderror"
                        ...
                        @foreach ($programas as $programa)
                            <option value="{{ $programa->id }}"
                                {{ $programa->id == $nacional->exmona_id_programa ? 'selected' : '' }}>
                    ...
                    <select class="form-control @error('exmona_id_persona') is-invalid @enderror"
                        ...
                        @foreach ($personas as $persona)
                            <option value="{{ $persona->id }}"
                                {{ $persona->id == $nacional->exmona_id_persona ? 'selected' : '' }}>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('exmona_institucion_proviene') is-invalid @enderror"
                        ...
                        autocomplete="exmona_institucion_proviene" autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox" value="Misión"
                            id="flexCheckChecked"
                            @foreach ($tipom as $m) {{ $m == 'Misión' ? 'checked' : '' }} @endforeach disabled>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                            ...
                            @foreach ($tipom as $m) {{ $m == 'Curso corto' ? 'checked' : '' }} @endforeach disabled>
                        <label class="form-check-label" for="flexCheckChecked">
                            Curso corto
                        </label>
                    </div>
                    <div class="tipo-estudiante" id="tipo-estudiante">
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Voluntariado' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                                Voluntariado
                            </label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Pasantia' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                                Pasantía
                            </label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Pasantia o práctica' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                                Pasantía o práctica
                            </label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Asistencia a eventos' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Curso de idiomas' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                                Curso de idiomas
                            </label>
                    ...
                    <div class="entrante-docente" id="entrante-docente">
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Estancia de investigación' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Profesor programa pregrado' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Profesor programa especialización' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Profesor programa maestría' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Profesor programa doctorado' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Profesor programa posdoctorado' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                    ...
                    <div class="saliente-docente" id="saliente-docente">
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Estudios de maestría' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Estudios de doctorado' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Estudios de posdoctorado' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                    ...
                    <div class="entrante-administrativo" id="entrante-administrativo">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                ...
                                @foreach ($tipom as $m) {{ $m == 'Pasantía' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
                                Pasantía
                            </label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" name="exmona_tipo_movilidad[]" type="checkbox"
                                value="Gestión de convenios" id="flexCheckChecked"
                                @foreach ($tipom as $m) {{ $m == 'Gestión de convenios' ? 'checked' : '' }} @endforeach
                                disabled>
                            <label class="form-check-label" for="flexCheckChecked">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('exmona_descripcion') is-invalid @enderror" name="exmona_descripcion"
                        id="exmona_descripcion" cols="30" rows="10"
                        disabled>{{ $nacional->exmona_descripcion }}</textarea>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('exmona_fecha_inicio') is-invalid @enderror"
                        ...
                        value="{{ $nacional->exmona_fecha_inicio }}" type="date" autocomplete="exmona_fecha_inicio"
                        autofocus disabled>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('exmona_fecha_final') is-invalid @enderror"
                        name="exmona_fecha_final" id="exmona_fecha_final" value="{{ $nacional->exmona_fecha_final }}"
                        type="date" autocomplete="exmona_fecha_final" autofocus disabled>
