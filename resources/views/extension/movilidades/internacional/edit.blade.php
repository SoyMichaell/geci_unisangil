...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/extension/{{$internacional->id}}/editarmovilidadinternacional">Editar</a> / <a href="/extension/mostrarmovilidadinternacional">Movilidad internacional</a> / <a href="/extension">Extension - internacionalización</a>
    @endsection
    @section('title')
