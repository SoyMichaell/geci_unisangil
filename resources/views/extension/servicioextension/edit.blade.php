...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/extension/{{$servicioextension->id}}/editarservicioextension">Editar</a> / <a href="/extension/mostrarservicioextension">Servicios extensión</a> / <a href="/extension">Extension - internacionalización</a>
    @endsection
    @section('title')
...
@section('content')
    <div class="container-fluid">
        <div class="tile">
            ...
            <form action="/extension/{{$servicioextension->id}}/actualizarservicioextension" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extseex_semestre') is-invalid @enderror"
                            name="extseex_semestre" id="extseex_semestre" value="{{$servicioextension->extseex_semestre}}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extseex_codigo_ser') is-invalid @enderror"
                            name="extseex_codigo_ser" id="extseex_codigo_ser" value="{{$servicioextension->extseex_codigo_ser}}"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extseex_nombre_ser') is-invalid @enderror"
                            name="extseex_nombre_ser" id="extseex_nombre_ser" value="{{$servicioextension->extseex_nombre_ser}}"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extseex_id_area_extension" id="extseex_id_area_extension">
                            ...
                            @foreach ($areas as $area)
                                <option value="{{ $area->id }}" {{$area->id == $servicioextension->extseex_id_area_extension ? 'selected' : ''}}>{{ $area->coarex_nombre }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extseex_fecha_inicio') is-invalid @enderror"
                            ...
                            value="{{$servicioextension->extseex_fecha_inicio}}" type="date" autocomplete="extseex_fecha_inicio"
                            autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extseex_fecha_final') is-invalid @enderror"
                            ...
                            value="{{$servicioextension->extseex_fecha_final}}" type="date" autocomplete="extseex_fecha_final"
                            autofocus>
                ...
                <h4 class="tile"><i class="fa fa-pencil"></i> Datos contacto</h4>
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extseex_costo" id="extseex_costo">
                            ...
                            <option value="No" {{$servicioextension->extseex_costo == 'No' ? 'selected' : ''}}>No</option>
                        </select>
                        @error('extseex_costo')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="extseex_criterio_elegibilidad"
                            id="extseex_criterio_elegibilidad" cols="30" rows="10">{{$servicioextension->extseex_criterio_elegibilidad}}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extseex_id_area_trabajo" id="extseex_id_area_trabajo">
                            ...
                            @foreach ($areastrabajo as $trabajo)
                                <option value="{{ $trabajo->id }}" {{$trabajo->id == $servicioextension->extseex_id_area_trabajo ? 'selected' : ''}}>{{ $trabajo->coartra_nombre }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extseex_id_ciclo_vital" id="extseex_id_ciclo_vital">
                            <option value="">---- SELECCIONE ----</option>
                            <option value="1" {{$servicioextension->extseex_id_ciclo_vital == '1' ? 'selected' : ''}}>Primera infancia (0-5 años)</option>
                            <option value="2" {{$servicioextension->extseex_id_ciclo_vital == '2' ? 'selected' : ''}}>Niñez (6-11 años)</option>
                            <option value="3" {{$servicioextension->extseex_id_ciclo_vital == '3' ? 'selected' : ''}}>Jóvenes (12-26 años)</option>
                            <option value="4" {{$servicioextension->extseex_id_ciclo_vital == '4' ? 'selected' : ''}}>Adultos (26-60 años)</option>
                            <option value="5" {{$servicioextension->extseex_id_ciclo_vital == '5' ? 'selected' : ''}}>Adultos mayores (+60 años)</option>
                        </select>
                ...
                <h4 class="tile"><i class="fa fa-pencil"></i> Fuente nacional</h4>
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="extseex_id_entidad_nacional"
                            ...
                            @foreach ($entidadesnac as $entidadenac)
                                <option value="{{ $entidadenac->id }}" {{$entidadenac->id == $servicioextension->extseex_id_entidad_nacional ? 'selected' : ''}}>{{ $entidadenac->coenna_nombre }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="extseex_id_fuente_nacional"
                            ...
                            @foreach ($fuentenacionals as $nacional)
                                <option value="{{ $nacional->id }}" {{$nacional->id == $servicioextension->extseex_id_fuente_nacional ? 'selected' : ''}}>{{ $nacional->cofuna_nombre }}</option>
                            @endforeach
                        </select>
                ...
                <h4 class="tile"><i class="fa fa-pencil"></i> Fuente internacional</h4>
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extseex_id_fuente_internacional"
                            ...
                            @foreach ($entidadesinter as $entidadinter)
                                <option value="{{ $entidadinter->id }}" {{$entidadinter->id == $servicioextension->extseex_id_fuente_internacional ? 'selected' : ''}}>{{ $entidadinter->cofuin_nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extseex_id_pais') is-invalid @enderror"
                            name="extseex_id_pais" id="extseex_id_pais" value="{{$servicioextension->extseex_id_pais}}"
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="extseex_id_sector_otra_entidad"
                            ...
                            @foreach ($sectores as $sector)
                                <option value="{{ $sector->id }}" {{$sector->id == $servicioextension->extseex_id_sector_otra_entidad ? 'selected' : ''}}>{{ $sector->cose_nombre }}</option>
                            @endforeach
                        </select>
                ...
                <h4 class="tile"><i class="fa fa-pencil"></i> Población condición</h4>
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extseex_id_poblacion_condicion"
                            ...
                            @foreach ($poblacioncondicions as $poblacioncondicion)
                                <option value="{{ $poblacioncondicion->id }}" {{$poblacioncondicion->id == $servicioextension->extseex_id_poblacion_condicion ? 'selected' : ''}}>
                ...
                <h4 class="tile"><i class="fa fa-pencil"></i> Población grupo</h4>
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="extseex_id_poblacion_grupo"
                            ...
                            @foreach ($poblaciongrupos as $poblaciongrupo)
                                <option value="{{ $poblaciongrupo->id }}" {{$poblaciongrupo->id == $servicioextension->extseex_id_poblacion_grupo ? 'selected' : ''}}>{{ $poblaciongrupo->copogr_nombre }}
                                </option>
                            @endforeach
                        </select>
