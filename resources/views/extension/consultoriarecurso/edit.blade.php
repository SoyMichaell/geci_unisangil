...
@section('content')
    <div class="container-fluid">
        <div class="tile">
            <form action="/extension/{{$consurecurso->id}}/actualizarconsurecurso" method="post">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extcor_semestre') is-invalid @enderror"
                            ...
                            value="{{$consurecurso->extcor_semestre}}" type="text"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="extcor_tipo_documento" id="extcor_tipo_documento">
                            ...
                            <option value="CC" {{$consurecurso->extcor_tipo_documento == 'CC' ? 'selected' : ''}}>Cédula de ciudadanía</option>
                            <option value="DE" {{$consurecurso->extcor_tipo_documento == 'DE' ? 'selected' : ''}}>Documento de identidad extranjera</option>
                            <option value="CE" {{$consurecurso->extcor_tipo_documento == 'CE' ? 'selected' : ''}}>Cédula de extranjería</option>
                            <option value="TI" {{$consurecurso->extcor_tipo_documento == 'TI' ? 'selected' : ''}}>Tarjeta de identidad</option>
                            <option value="PS" {{$consurecurso->extcor_tipo_documento == 'PS' ? 'selected' : ''}}>Pasaporte</option>
                            <option value="CA" {{$consurecurso->extcor_tipo_documento == 'CA' ? 'selected' : ''}}>Certificado cabildo</option>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="extcor_id_nivel_estudio" id="extcor_id_nivel_estudio">
                            ...
                            @foreach ($nivelestudios as $nivelestudio)
                                <option value="{{$nivelestudio->id}}" {{$nivelestudio->id == $consurecurso->extcor_id_nivel_estudio ? 'selected' : ''}}>{{$nivelestudio->conies_nombre}}</option>
                            @endforeach
                        </select>
