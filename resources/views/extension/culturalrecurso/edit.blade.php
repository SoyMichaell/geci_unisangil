...
@section('content')
    <div class="container-fluid">
        <div class="tile">
            <form action="/extension/{{$actrecurso->id}}/actualizaractrecurso" method="post">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="extculre_tipo_documento" id="extculre_tipo_documento">
                            ...
                            <option value="CC" {{$actrecurso->extculre_tipo_documento == 'CC' ? 'selected' : ''}}>Cédula de ciudadanía</option>
                            <option value="DE" {{$actrecurso->extculre_tipo_documento == 'DE' ? 'selected' : ''}}>Documento de identidad extranjera</option>
                            <option value="CE" {{$actrecurso->extculre_tipo_documento == 'CE' ? 'selected' : ''}}>Cédula de extranjería</option>
                            <option value="TI" {{$actrecurso->extculre_tipo_documento == 'TI' ? 'selected' : ''}}>Tarjeta de identidad</option>
                            <option value="PS" {{$actrecurso->extculre_tipo_documento == 'PS' ? 'selected' : ''}}>Pasaporte</option>
                            <option value="CA" {{$actrecurso->extculre_tipo_documento == 'CA' ? 'selected' : ''}}>Certificado cabildo</option>
                        </select>
