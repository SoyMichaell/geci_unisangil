            ...
            <form action="/extension/{{$consultoria->id}}/actualizarconsultoria" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="extcon_descripcion" id="extcon_descripcion" cols="30" rows="10" disabled>{{$consultoria->extcon_descripcion}}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extcon_valor') is-invalid @enderror"
                            ...
                            type="number" autocomplete="extcon_valor" autofocus disabled>
                        @error('extcon_valor') 
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extcon_fecha_inicio') is-invalid @enderror"
                            ...
                            type="date" autocomplete="extcon_fecha_inicio" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extcon_fecha_fin') is-invalid @enderror"
                            ...
                            type="date" autocomplete="extcon_fecha_fin" autofocus disabled>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extcon_valor_nacional') is-invalid @enderror"
                            ...
                            type="number" autocomplete="extcon_valor_nacional" autofocus disabled>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extcon_nombre_institucion') is-invalid @enderror"
                            ...
                            type="text" autocomplete="extcon_nombre_institucion" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="extcon_fuente_internacional" id="extcon_fuente_internacional" disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3"> 
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extcon_pais') is-invalid @enderror"
                            ...
                            type="number" autocomplete="extcon_pais" autofocus disabled>
                        @error('extcon_pais') 
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('extcon_valor_internacional') is-invalid @enderror"
                            ...
                            type="number" autocomplete="extcon_valor_internacional" autofocus disabled>
