...
@section('content')
    <div class="container">
        @if ($trabajo->tra_modalidad_grado == '10')
            <div class="tile">
                <h4><i class="fa fa-cube"></i> Registro trabajo de grado</h4>
                <hr>
                <form action="/trabajo/{{$trabajo->id}}" method="post">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="js-example-placeholder-single form-control" name="tra_id_estudiante[]"
                                ...
                                @foreach ($estudiantes as $estudiante)
                                    <option value="{{ $estudiante->per_nombre . ' ' . $estudiante->per_apellido }}" @foreach ($estudiantex as $estu) {{ $estu == $estudiante->per_nombre . ' ' . $estudiante->per_apellido ? 'selected' : '' }} @endforeach>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="js-example-placeholder-single form-control" name="tra_modalidad_grado"
                                ...
                                @foreach ($modalidades as $modalidad)
                                    <option value="{{ $modalidad->id }}" {{$modalidad->id == $trabajo->tra_modalidad_grado ? 'selected' : ''}}>{{ $modalidad->mod_nombre }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3" id="practica-laboral">
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="tra_id_empresa" id="tra_id_empresa">
                                <option value="">---- SELECCIONE ----</option>
                                @foreach ($empresas as $empresa)
                                    <option value="{{ $empresa->id }}" {{$empresa->id == $trabajo->tra_id_empresa ? 'selected' : ''}}>
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control @error('tra_cargo') is-invalid @enderror" name="tra_cargo"
                                id="tra_cargo" value="{{$trabajo->tra_cargo}}" type="text" autocomplete="tra_cargo"
                                autofocus>
                            @error('tra_cargo')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="js-example-placeholder-single form-control" name="tra_id_director"
                                ...
                                @foreach ($personas as $persona)
                                    <option value="{{ $persona->id }}" {{ $persona->id == $trabajo->tra_id_director ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="js-example-placeholder-single form-control" name="tra_id_codirector"
                                ...
                                <option value="">---- SELECCIONE ----</option>
                                @foreach ($personas as $persona)
                                    <option value="{{ $persona->id }}" {{ $persona->id == $trabajo->tra_id_codirector ? 'selected' : '' }}>
                                        {{ $persona->per_nombre . ' ' . $persona->per_apellido }}</option>
                                @endforeach
                            </select>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $trabajo->tra_id_proceso == 2 ? 'active tile' : '' }}" id="fasestado-tab"
                        data-toggle="tab" href="#fasestado" role="tab" aria-controls="fasestado"
                        aria-selected="true">Fase
                        estado proyecto</a>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $trabajo->tra_id_proceso == 4 ? 'active tile' : '' }}" id="faseacta-tab"
                        data-toggle="tab" href="#faseacta" role="tab" aria-controls="faseacta"
                        aria-selected="false">Fase
                        actas / cierre</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $trabajo->tra_id_proceso == 5 ? 'active tile' : '' }}"
                        id="fasecontrato-tab" data-toggle="tab" href="#fasecontrato" role="tab"
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $trabajo->tra_id_proceso == 6 ? 'active tile' : '' }}" id="fasefinal-tab"
                        data-toggle="tab" href="#fasefinal" role="tab" aria-controls="fasefinal"
                        aria-selected="false">Fase
                        final</a>
                </li>
            </ul>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <select class="js-example-placeholder-single form-control" name="tra_id_estudiante[]"
                                    ...
                                    @foreach ($estudiantes as $estudiante)
                                        <option
                                            value="{{ $estudiante->per_nombre . ' ' . $estudiante->per_apellido }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control @error('tra_fecha_inicio') is-invalid @enderror"
                                    ...
                                    value="{{ $trabajo->tra_fecha_inicio }}" type="date"
                        ...
                        <form action="/trabajo/{{ $trabajo->id }}/faseestado" method="post">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="tra_estado_propuesta"
                                        id="tra_estado_propuesta">
                                        <option value="">---- SELECCIONE ----</option>
                                        <option value="aprobada"
                                            {{ $trabajo->tra_estado_propuesta == 'aprobada' ? 'selected' : '' }}>
                                            Aprobada
                                        </option>
                                        ...
                                        <option value="aplazada"
                                            {{ $trabajo->tra_estado_propuesta == 'aplazada' ? 'selected' : '' }}>
                                            Aplazada
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="tra_estado_proyecto" id="tra_estado_proyecto">
                                        ...
                                        <option value="anulado"
                                            {{ $trabajo->tra_estado_proyecto == 'anulado' ? 'selected' : '' }}>
                                            Anulado
                                        </option>
                                    </select>
                        ...
                        <form action="/trabajo/{{ $trabajo->id }}/fasejurado" method="post">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="js-example-placeholder-single form-control" name="tra_id_jurado1"
                                        id="tra_id_jurado1">
                                        <option value="">---- SELECCIONE ----</option>
                                        @foreach ($personas as $persona)
                                            <option value="{{ $persona->id }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="js-example-placeholder-single form-control" name="tra_id_jurado2"
                                        id="tra_id_jurado2">
                                        <option value="">---- SELECCIONE ----</option>
                                        @foreach ($personas as $persona)
                                            <option value="{{ $persona->id }}"
