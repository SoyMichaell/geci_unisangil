        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('per_tipo_documento') is-invalid @enderror" name="per_tipo_documento"
                                    ...
                                    <option value="Tarjeta de identidad" {{$persona->per_tipo_documento == 'Tarjeta de identidad' ? 'selected' : ''}}>Tarjeta de identidad</option>
                                    <option value="Cédula de ciudadania" {{$persona->per_tipo_documento == 'Cédula de ciudadania' ? 'selected' : ''}}>Cédula de ciudadanía</option>
                                    <option value="Cédula de extranjeria" {{$persona->per_tipo_documento == 'Cédula de extranjeria' ? 'selected' : ''}}>Cédula de extranjeria</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="per_numero_documento" type="number"
                                    ...
                                    value="{{$persona->per_numero_documento}}" autocomplete="per_numero_documento" autofocus>
                ...
                <div class="tile col-md-4">
                    <h4><i class="fa fa-close"></i> Actualizar contraseña</h4> <hr>
                    <form action="/usuario/{{$persona->id}}/actualizar_password" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <div class="col-md-12">
            ...
            <div class="row">
                <div class="tile col-md-12">
                    <h4><i class="fa fa-cube"></i> Cambio tipo de usuario</h4><hr>
                    <form action="/usuario/{{$persona->id}}/tipousuariocambio" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <div class="col-md-12">
