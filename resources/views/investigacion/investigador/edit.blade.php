                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <select class="form-control @error('inves_id_persona') is-invalid @enderror"
                            ...
                            @foreach ($personas as $persona)
                                <option value="{{ $persona->id }}" {{$investigador->inves_id_persona == $persona->id ? 'selected' : ''}}>
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <input id="inves_enlace_cvlac" type="url"
                            ...
                            value="{{$investigador->inves_enlace_cvlac}}" autocomplete="inves_enlace_cvlac" autofocus>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input id="inves_tipo_vinculacion" type="text"
                            ...
                            name="inves_tipo_vinculacion" value="{{$investigador->inves_tipo_vinculacion}}"
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <input id="inves_categoria" type="text"
                            ...
                            name="inves_categoria" value="{{$investigador->inves_categoria}}"
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="form-control @error('inves_id_grupo') is-invalid @enderror"
                            ...
                            @foreach ($grupos as $grupo)
                                <option value="{{ $grupo->id }}" {{$investigador->inves_id_grupo == $grupo->id ? 'selected' : ''}}>
