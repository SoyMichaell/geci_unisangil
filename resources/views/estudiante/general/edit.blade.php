...
@section('content')
    <div class="container-fluid">
        <div class="tile w-100">
            ...
            <form action="/estudiante/{{$general->id}}/actualizarreporte" method="post">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input id="esture_year" type="number"
                            class="form-control @error('esture_year') is-invalid @enderror" name="esture_year"
                            value="{{$general->esture_year}}" autocomplete="esture_year" autofocus>
                        @error('esture_year')
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="esture_id_programa" id="esture_id_programa">
                            ...
                            @foreach ($programas as $programa)
                                <option value="{{ $programa->id }}" {{$programa->id == $general->esture_id_programa ? 'selected' : ''}}>{{ $programa->pro_nombre }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="esture_periodo" type="text"
                            ...
                            value="{{$general->esture_periodo}}" autocomplete="esture_periodo" autofocus>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input id="esture_inscritos" type="number"
                            ...
                            value="{{$general->esture_inscritos}}" autocomplete="esture_inscritos" autofocus>
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="esture_admitidos" type="number"
                            ...
                            value="{{$general->esture_admitidos}}" autocomplete="esture_admitidos" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="esture_mat_total" type="number"
                            ...
                            value="{{$general->esture_mat_total}}" autocomplete="esture_mat_total" autofocus>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input id="esture_graduados" type="number"
                            ...
                            value="{{$general->esture_graduados}}" autocomplete="esture_graduados" autofocus>
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="esture_retirados" type="number"
                            ...
                            value="{{$general->esture_retirados}}" autocomplete="esture_retirados" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <label
                            for="esture_porcentaje_termina">{{ __('Porcentaje que culmina el programa *') }}</label>
