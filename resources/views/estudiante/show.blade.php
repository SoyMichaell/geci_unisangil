...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/estudiante/{{$persona->id}}">Vista</a> / <a href="/estudiante">Estudiante</a>
    @endsection
    @section('title')
...
@section('content')
    <div class="container-fluid">
        <div class="tile w-100">
            <h4 class="title"><i class="fa fa-question-circle"></i> Registro estudiante</h4><hr>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="estu_programa">{{ __('Programa *') }}</label>
                        <select class="form-control" name="estu_programa" id="estu_programa" disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_programa_plan" id="estu_programa_plan" disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_tipo_documento" id="estu_tipo_documento" disabled>
                            <option value="">---- SELECCIONE ----</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="estu_numero_documento" type="number"
                            ...
                            autocomplete="estu_numero_documento" autofocus disabled>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="estu_nombre" type="text"
                            ...
                            value="{{ $persona->per_nombre }}" autocomplete="estu_nombre" autofocus disabled>
                        @error('estu_nombre')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="estu_apellido" type="text"
                            ...
                            value="{{ $persona->per_apellido }}" autocomplete="estu_apellido" autofocus disabled>
                        @error('estu_apellido')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="estu_telefono1" type="number"
                            ...
                            value="{{ $persona->per_telefono }}" autocomplete="estu_telefono1" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="estu_telefono2" type="number"
                            ...
                            value="{{ $persona->estu_telefono2 }}" autocomplete="estu_telefono2" autofocus disabled>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="estu_direccion" type="text"
                            ...
                            value="{{ $persona->estu_direccion }}" autocomplete="estu_direccion" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="estu_correo" type="email"
                            ...
                            value="{{ $persona->per_correo }}" autocomplete="estu_correo" autofocus disabled>
                        @error('estu_correo')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="estu_estrato" type="text"
                            ...
                            value="{{ $persona->estu_estrato }}" autocomplete="estu_estrato" autofocus disabled>
                        @error('estu_estrato')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_departamento" id="estu_departamento" disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_ciudad" id="estu_ciudad" disabled>
                            <option value="">---- SELECCIONE ----</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="estu_fecha_nacimiento" type="date"
                            ...
                            autocomplete="estu_fecha_nacimiento" autofocus disabled>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_sexo" id="estu_sexo" disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_estado_civil" id="estu_estado_civil" disabled>
                            <option value="">---- SELECCIONE ----</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="estu_ingreso" type="text"
                            ...
                            value="{{ $persona->estu_ingreso }}" autocomplete="estu_ingreso" autofocus disabled>
                        @error('estu_ingreso')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="estu_ult_matricula" type="text"
                            ...
                            autocomplete="estu_ult_matricula" autofocus placeholder="Ej: 2022-1" disabled>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_semestre" id="estu_semestre" disabled>
                            <option value="">---- SELECCIONE ----</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_financiamiento" id="estu_financiamiento" disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="estu_entidad" type="text"
                            ...
                            value="{{ $persona->estu_entidad }}" autocomplete="estu_entidad" autofocus disabled>
                        @error('estu_entidad')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_estado" id="estu_estado" disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_tipo_matricula" id="estu_tipo_matricula" disabled>
                            <option value="">---- SELECCIONE ----</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="estu_matricula" id="estu_matricula" disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="estu_pga" type="text" class="form-control @error('estu_pga') is-invalid @enderror"
                            name="estu_pga" value="{{ $persona->estu_pga }}" autocomplete="estu_pga" autofocus disabled>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input id="estu_reconocimiento" type="number"
                            ...
                            autocomplete="estu_reconocimiento" autofocus disabled>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select class="form-control" name="estu_egresado" id="estu_egresado" disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select class="form-control" name="estu_administrativo" id="estu_administrativo" disabled>
                ...
                <div class="row mb-3" id="administrativo-estudiante">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="estu_cargo" type="text"
                            ...
                            value="{{$persona->estu_cargo}}" autocomplete="estu_cargo" autofocus disabled>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input id="estu_dependencia" type="text"
                            ...
                            autocomplete="estu_dependencia" autofocus disabled>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input id="estu_fecha_ingreso" type="date"
                            ...
                            autocomplete="estu_fecha_ingreso" autofocus disabled>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input id="estu_no_contrato" type="text"
                            ...
                            autocomplete="estu_no_contrato" autofocus disabled>
                    </div>
                </div>
        </div>
    </div>
