            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input id="estu_apellido" type="text"
                        ...
                        value="{{ $estudiante->estu_apellido }}" autocomplete="estu_apellido" autofocus disabled>
                    @error('estu_apellido')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-6">
                    ...
                    <input id="estu_telefono1" type="number"
                        ...
                        value="{{ $estudiante->estu_telefono1 }}" autocomplete="estu_telefono1" autofocus disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input id="estu_direccion" type="text"
                        ...
                        value="{{ $estudiante->estu_direccion }}" autocomplete="estu_direccion" autofocus disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input id="estu_estrato" type="text"
                        ...
                        value="{{ $estudiante->estu_estrato }}" autocomplete="estu_estrato" autofocus disabled>
                    @error('estu_estrato')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input id="estu_entidad" type="text"
                        ...
                        value="{{ $estudiante->estu_entidad }}" autocomplete="estu_entidad" autofocus disabled>
                    @error('estu_entidad')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="estu_estado" id="estu_estado" disabled>
                        <option value="">---- SELECCIONE ----</option>
                        <option value="activo" {{ $estudiante->estu_estado == 'activo' ? 'selected' : '' }}>Activo
                        </option>
                        ...
                        <option value="egresado" {{ $estudiante->estu_estado == 'egresado' ? 'selected' : '' }}>
                            Egresado</option>
                        <option value="egresado-no-graduado"
                            {{ $estudiante->estu_estado == 'egresado-no-graduado' ? 'selected' : '' }}>Egresado no
                            Graduado</option>
                    </select>
                    @error('estu_estado')
                        <span class="invalid-feedback" role="alert">
