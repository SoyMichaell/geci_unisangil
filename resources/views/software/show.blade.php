                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="sof_desarrollador" type="text"
                            ...
                            value="{{$software->sof_desarrollador}}" autocomplete="sof_desarrollador" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="sof_version" type="text"
                            ...
                            value="{{$software->sof_version}}" autocomplete="sof_version" autofocus disabled>
                        @error('sof_version')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="sof_no_licencia" type="text"
                            ...
                            value="{{$software->sof_no_licencia}}" autocomplete="sof_no_licencia" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="sof_year_ad_licencia" type="text"
                            ...
                            value="{{$software->sof_year_ad_licencia}}" autocomplete="sof_year_ad_licencia" autofocus disabled>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="sof_year_ve_licencia" type="text"
                            ...
                            value="{{$software->sof_year_ve_licencia}}" autocomplete="sof_year_ve_licencia" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('sof_asignatura') is-invalid @enderror" name="sof_asignatura" id="sof_asignatura" multiple disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="sof_cantidad" type="number"
                            ...
                            value="{{$software->sof_cantidad}}" autocomplete="sof_cantidad" autofocus disabled>
                        @error('sof_cantidad')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('sof_id_programa') is-invalid @enderror" name="sof_id_programa" id="sof_id_programa" multiple disabled>
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="sof_valor_unitario" type="text"
                            ...
                            value="{{$software->sof_valor_unitario}}" autocomplete="sof_valor_unitario" autofocus disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="sof_valor_total" type="text"
                            ...
                            value="{{$software->sof_valor_total}}" autocomplete="sof_valor_total" autofocus disabled>
