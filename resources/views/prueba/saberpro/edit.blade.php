...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/prueba/{{ $saber->prsapr_id_estudiante }}/editarsaberpro">Editar</a> / <a href="/prueba/mostrarsaberpro">Saber pro</a> /
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control @error('prsapr_year') is-invalid @enderror" name="prsapr_year"
                            id="prsapr_year" value="{{ $saber->prsapr_year }}" type="number"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3 mb-3 d-none">
                            <input class="form-control @error('prsaprmo_id_modulo') is-invalid @enderror"
                                ...
                                value="{{ $saberx->prsaprmo_id_modulo }}" type="text"
                                autocomplete="prsaprmo_id_modulo" autofocus readonly>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input class="form-control @error('prsaprmo_puntaje') is-invalid @enderror"
                                ...
                                value="{{ $saberx->prsaprmo_puntaje }}" type="number" autocomplete="prsaprmo_puntaje"
                                autofocus>
