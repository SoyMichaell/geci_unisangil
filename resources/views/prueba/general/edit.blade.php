                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control @error('prurepro_year') is-invalid @enderror" name="prurepro_year"
                            ...
                            autocomplete="prurepro_year" autofocus>
                        @error('prurepro_year')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" name="prurepromo_id_prueba_programa"
                            id="prurepromo_id_prueba_programa">
                            <option value="">---- SELECCIONE ----</option>
                            @foreach ($programas as $programa)
                                <option value="{{ $programa->id }}" {{$programa->id == $resultado->prurepromo_id_prueba_programa ? 'selected' : ''}}>
                    ...
                    @foreach ($resultados as $resultadox)
                        ...
                        <div class="col-md-3 mb-3 d-none">
                            <input class="form-control @error('prureprono_id_modulo') is-invalid @enderror"
                                ...
                                value="{{$resultadox->prureprono_id_modulo}}" type="hidden" autocomplete="prureprono_id_modulo"
                                autofocus readonly>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input class="form-control @error('prureprono_puntaje_programa') is-invalid @enderror"
                                ...
                                autocomplete="prureprono_puntaje_programa" autofocus>
