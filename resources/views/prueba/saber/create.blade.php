...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/prueba/crearsaber">Crear</a> / <a href="/prueba/mostrarsaber">Saber 11</a> / <a href="/prueba">Pruebas
            saber</a>
    @endsection
    @section('title')
    ...
    <div class="container">
        <div class="tile">
                ...
                <form action="/prueba/registrosaber" method="post">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control js-example-placeholder-single" name="prueba_saber_id_estudiante"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input class="form-control @error('prueba_saber_periodo') is-invalid @enderror"
                                ...
                                value="{{ old('prueba_saber_periodo') }}" type="text"
                                autocomplete="prueba_saber_periodo" autofocus required>
                        ...
                        @foreach ($tiposmodulos as $tiposmodulo)
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="prsamo_id_modulo">{{ $tiposmodulo->tipo_modulo_nombre }}</label> | <label
                                    for="prsamo_puntaje">Puntaje *</label>
            ...
            <div class="alert alert-warning" role="alert">
                No existen módulos para registrar pruebas saber 11 <a href="/prueba/mostrartipomodulo" class="alert-link">Registrar aquí</a>. 
              </div>
            @endif
        </div>
    </div>
