                    ...
                    <form action="/docente/registroevaluacion" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('doe_semestre') is-invalid @enderror"
                                    name="doe_semestre" id="doe_semestre">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="doe_total_pro" type="text"
                                    class="form-control @error('doe_total_pro') is-invalid @enderror"
                                    name="doe_total_pro" value="{{ old('doe_total_pro') }}"
                                    autocomplete="doe_total_pro">
                                @error('doe_total_pro')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
