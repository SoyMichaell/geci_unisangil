    ...
    <div class="container-fluid">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane show active tile p-3" id="fase1" role="tabpanel" aria-labelledby="fase1-tab">
                <form action="/docente/{{ $docentevisitante->id }}/actualizardocentevisitante" method="post"
                            ...
                            <div class="col-md-12">
                                <select class="form-control @error('docvi_tipo_documento') is-invalid @enderror"
                                    ...
                                    <option value="Tarjeta de identidad"
                                        {{ $docentevisitante->docvi_tipo_documento == 'Tarjeta de identidad' ? 'selected' : '' }}>
                                        Tarjeta de identidad</option>
                                    <option value="Cédula de ciudadania"
                                        {{ $docentevisitante->docvi_tipo_documento == 'Cédula de ciudadania' ? 'selected' : '' }}>
                                        Cédula de ciudadania</option>
                                    <option value="Cédula de extranjeria"
                                        {{ $docentevisitante->docvi_tipo_documento == 'Cédula de extranjeria' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_numero_documento" type="number"
                                    ...
                                    name="docvi_numero_documento"
                                    value="{{ $docentevisitante->docvi_numero_documento }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_nombre" type="text"
                                    ...
                                    value="{{ $docentevisitante->docvi_nombre }}" autocomplete="docvi_nombre"
                                    autofocus>
                                @error('docvi_nombre')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_apellido" type="text"
                                    ...
                                    name="docvi_apellido" value="{{ $docentevisitante->docvi_apellido }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_telefono" type="number"
                                    ...
                                    name="docvi_telefono" value="{{ $docentevisitante->docvi_telefono }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_correo" type="email"
                                    ...
                                    value="{{ $docentevisitante->docvi_correo }}" autocomplete="docvi_correo"
                                    autofocus>
                                @error('docvi_correo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_entidad_origen" type="text"
                                    ...
                                    name="docvi_entidad_origen" value="{{ $docentevisitante->docvi_entidad_origen }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_pais" type="text"
                                    ...
                                    value="{{ $docentevisitante->docvi_pais }}" autocomplete="docvi_pais" autofocus>
                                @error('docvi_pais')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_ciudad" type="text"
                                    ...
                                    value="{{ $docentevisitante->docvi_ciudad }}" autocomplete="docvi_ciudad"
                                    autofocus>
                                @error('docvi_ciudad')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_fecha_estadia" type="date"
                                    ...
                                    name="docvi_fecha_estadia" value="{{ $docentevisitante->docvi_fecha_estadia }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_cantidad_hora" type="text"
                                    ...
                                    name="docvi_cantidad_hora" value="{{ $docentevisitante->docvi_cantidad_hora }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_cantidad_dia" type="text"
                                    ...
                                    name="docvi_cantidad_dia" value="{{ $docentevisitante->docvi_cantidad_dia }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_cantidad_semana" type="text"
                                    ...
                                    name="docvi_cantidad_semana" value="{{ $docentevisitante->docvi_cantidad_semana }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_cantidad_mes" type="text"
                                    ...
                                    name="docvi_cantidad_mes" value="{{ $docentevisitante->docvi_cantidad_mes }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_cantidad_year" type="text"
                                    ...
                                    name="docvi_cantidad_year" value="{{ $docentevisitante->docvi_cantidad_year }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" name="docvi_objeto" id="docvi_objeto" cols="30"
                                    rows="10">{{ $docentevisitante->docvi_objeto }}</textarea>
                                @error('docvi_objeto')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" name="docvi_actividad_desarrolladas"
                                    id="docvi_actividad_desarrolladas" cols="30"
                                    rows="10">{{ $docentevisitante->docvi_actividad_desarrolladas }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="docvi_year" class="col-md-12 col-form-label">{{ __('Año *') }}</label>
                            <div class="col-md-12">
                                <input id="docvi_year" type="number"
                                    class="form-control @error('docvi_year') is-invalid @enderror" name="docvi_year"
                                    value="{{ $docentevisitante->docvi_year }}" autocomplete="docvi_year" autofocus>
                                @error('docvi_year')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_periodo" type="text"
                                    ...
                                    name="docvi_periodo" value="{{ $docentevisitante->docvi_periodo }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <input id="docvi_url_soporte" type="file"
                                    ...
                                    name="docvi_url_soporte" value="{{ $docentevisitante->docvi_url_soporte }}"
                                ...
                                @enderror
                                <a href="{{asset('datos/visitante/'.$docentevisitante->docvi_url_soporte)}}"><small>{{ $docentevisitante->docvi_url_soporte }}</small></a>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
