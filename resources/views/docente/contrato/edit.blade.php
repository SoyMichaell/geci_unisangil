...
@else
    @extends('layouts.app')
    @section('navegar')
        <a href="/docente/{{$persona->id}}/{{$contrato->id}}/editarcontrato">Editar</a> / <a href="/docente/{{$persona->id}}/mostrarcontrato">Contrato</a> / <a href="/docente">Docente</a>
    @endsection
    @section('title')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="doco_numero_contrato" type="text" class="form-control @error('doco_numero_contrato') is-invalid @enderror"
                            name="doco_numero_contrato" value="{{$contrato->doco_numero_contrato}}" autocomplete="doco_numero_contrato">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="doco_objeto_contrato" id="doco_objeto_contrato" cols="30" rows="10">{{$contrato->doco_objeto_contrato}}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="doco_tipo_contrato" id="doco_tipo_contrato">
                            ...
                            <option value="ops" {{$contrato->doco_tipo_contrato == 'ops' ? 'selected' : ''}}>OPS</option>
                            <option value="nomina" {{$contrato->doco_tipo_contrato == 'nomina' ? 'selected' : ''}}>Nomina</option>
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <input id="doco_fecha_inicio" type="date" class="form-control @error('doco_fecha_inicio') is-invalid @enderror"
                            name="doco_fecha_inicio" value="{{$contrato->doco_fecha_inicio}}" autocomplete="doco_fecha_inicio">
                    ...
                    <div class="col-md-3">
                        ...
                        <input id="doco_fecha_fin" type="date" class="form-control @error('doco_fecha_fin') is-invalid @enderror"
                            name="doco_fecha_fin" value="{{$contrato->doco_fecha_fin}}" autocomplete="doco_fecha_fin">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="doco_rol" id="doco_rol">
                            <option value="">---- SELECCIONE ----</option>
                            <option value="director" {{$contrato->doco_rol == 'director' ? 'selected' : ''}}>Director</option>
                            <option value="docente-catedra" {{$contrato->doco_rol == 'docente-catedra' ? 'selected' : ''}}>Docente catedra</option>
                            <option value="docente-tc" {{$contrato->doco_rol == 'docente-tc' ? 'selected' : ''}}>Docente TC</option>
                            <option value="jurado-tesis" {{$contrato->doco_rol == 'jurado-tesis' ? 'selected' : ''}}>Jurado de tesis</option>
                        </select>
                        @error('doco_rol')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
