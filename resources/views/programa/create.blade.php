            ...
            <form action="/programa" method="post">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select class="form-select" name="pro_estado_programa"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <select class="form-select" name="pro_departamento"
                                    id="pro_departamento">
                                    <option selected>---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <select class="form-select" name="pro_municipio"
                                    id="pro_municipio">
                                    <option selected>---- SELECCIONE ----</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <select class="form-select" name="pro_facultad"
                                    id="pro_facultad">
                                    <option selected>---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <select class="form-select" name="pro_nivel_formacion"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="pro_programa_ciclos"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <select class="form-select" name="pro_metodologia"
                                    id="pro_metodologia">
                                    <option selected>---- SELECCIONE ----</option>
