...
@section('content')
    <div class="col-md-12">
        <div class="tile">
            <h4 class="tile title"><i class="fab fa-wpforms"></i> Actulizar información</h4>
            <form action="/asignatura/{{ $asignatura->id }}" method="post">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="pas_id_municipio">{{ __('Sede *') }}</label>
                        <select class="form-select @error('pas_id_municipio') is-invalid @enderror" name="pas_id_municipio" id="pas_id_municipio">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('pas_id_facultad') is-invalid @enderror" name="pas_id_facultad" id="pas_id_facultad">
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('pas_id_programa') is-invalid @enderror" name="pas_id_programa" id="pas_id_programa">
                            <option value="">---- SELECCIONE ----</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('pas_id_programa_plan') is-invalid @enderror" name="pas_id_programa_plan" id="pas_id_programa_plan">
                            <option value="">---- SELECCIONE ----</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="pas_nombre" type="text"
                            class="form-control @error('pas_nombre') is-invalid @enderror" name="pas_nombre"
                            value="{{ $asignatura->pas_nombre }}" autocomplete="pas_nombre" autofocus>
                        @error('pas_nombre')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="pas_creditos" type="number"
                            ...
                            value="{{ $asignatura->pas_creditos }}" autocomplete="pas_creditos" autofocus>
                        @error('pas_creditos')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="pas_horas_semana" type="number"
                            ...
                            value="{{ $asignatura->pas_horas_semana }}" autocomplete="pas_horas_semana" autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="pas_horas_semestre" type="number"
                            class="form-control @error('pas_horas_semestre') is-invalid @enderror"
                            name="pas_horas_semestre" value="{{ $asignatura->pas_horas_semestre }}"
                            autocomplete="pas_horas_semestre" autofocus>
